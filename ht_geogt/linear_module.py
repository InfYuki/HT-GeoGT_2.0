# 创建新文件: ht_geogt/linear_module.py
...
from ht_geogt.model.modeling_geoformer_linear import create_linear_model


class LinearLNNP(LightningModule):
    def __init__(self, config) -> None:
        super(LinearLNNP, self).__init__()

        self.save_hyperparameters(config)
        self.model = create_linear_model(self.hparams)
    ...
    def forward(self, batch):
        return self.model(x=batch["x"], z=batch["z"], pos=batch["pos"])
